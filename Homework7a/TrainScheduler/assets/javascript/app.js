$(document).ready(function() {
    ...
    $("#submit-btn").on("click", function(event) {
        ...
        //logic for storing and retrieving latest information.
    ...
    dataRef.ref().on("child_added", function(childSnapshot) {
        ...
        //create new variables for clean build from childSnapshot of firebase data 
        ...
        //code math to find next train time and minutes until next arrival based off frequency first train time values.
